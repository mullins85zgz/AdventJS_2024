...
function decodeFilename(filename) {
    ...
    // Encuentra el índice del primer guion bajo
    const firstUnderscoreIndex = filename.indexOf('_');

    // Encuentra el índice del último punto
    const lastDotIndex = filename.lastIndexOf('.');

    // Extrae la parte importante del nombre del archivo
    const decodedFilename = filename.slice(firstUnderscoreIndex + 1, lastDotIndex);
